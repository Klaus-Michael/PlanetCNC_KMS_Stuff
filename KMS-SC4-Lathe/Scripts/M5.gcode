...
O<ToolCheck> if [ #<_current_tool> EQ #<_tool_life_toolnumber> and #<_tool_life_starttime> gt 0]
	...
	(print, Tool Number: #<_current_tool>, Total Runtime: #<tool_life_new_runtime>, old runtime  #<tool_life_old_runtime>, Runtime: #<_tool_life_runtime>, Starttime: #<_tool_life_starttime>, Endtime: #<_tool_life_endtime> )
