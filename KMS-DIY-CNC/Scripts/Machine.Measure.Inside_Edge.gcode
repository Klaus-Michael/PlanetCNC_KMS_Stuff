...
(dlgnew, Measure Inside Edge)
(dlg, text='Select direction', typ=label, color=0xffa500)
(dlg, name='data::MeasureEdgeInsideXp', typ=image, x=20)
(dlg, name='data::MeasureEdgeInsideXn', typ=image, x=160, y=-1)
(dlg, name='data::MeasureEdgeInsideYp', typ=image, x=300, y=-1)
(dlg, name='data::MeasureEdgeInsideYn', typ=image, x=440, y=-1)
(dlg, name='', items='|X+|X-|Y+|Y-~', typ=checkbox, def=1, param=orient, store, x=50, w=140)
(dlg, typ=separator)
