...
O<ToolCheck> if [ #<_current_tool> EQ #<_tool_life_toolnumber> and #<_tool_life_starttime> gt 0]
	...
	O<ToolCheckRecord> if [Exists[#<_tool_par1|#<_current_tool>>]]
		#<tool_life_old_runtime> = #<_tool_par1|#<_current_tool>>
	...
	#<_tool_par1|#<_current_tool>>= #<tool_life_new_runtime> 
	...
	O<CheckToolTableChange> if [ #<_tool_par1|#<_current_tool>> NE #<tool_life_new_runtime>  ]
		(print, Tool Table update NOT successfull. Trying again! tool table value #<_tool_par1|#<_current_tool>> should be value #<tool_life_new_runtime>)
		#<_tool_par1|#<_current_tool>>= #<tool_life_new_runtime> 
		(print, Tool Table value after second try: #<_tool_par1|#<_current_tool>>)
...
O<checkforspindlerun> while [#<_input|5> EQ 1]
