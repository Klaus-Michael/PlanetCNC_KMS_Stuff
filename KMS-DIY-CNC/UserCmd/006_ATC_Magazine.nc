...
o<cleanuploop> while [#<loop_tool_number> lt 1000]
	...
	o<toolexists> if[#<_tool_exists|#<loop_tool_number>> GT 0]
		...
		#<_tool_par6_num|#<loop_tool_number>> = 0
	o<toolexists> endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_0> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_0>> = #<ATC_Pocket_Type_0>
	o<toolexists> endif
o<chk_pocket>endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_1> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_1>> = #<ATC_Pocket_Type_1>
	o<toolexists> endif
o<chk_pocket>endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_2> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_2>> = #<ATC_Pocket_Type_2>
	o<toolexists> endif
o<chk_pocket>endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_3> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_3>> = #<ATC_Pocket_Type_3>
	o<toolexists> endif
o<chk_pocket>endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_4> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_4>> = #<ATC_Pocket_Type_4>
	o<toolexists> endif
o<chk_pocket>endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_5> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_5>> = #<ATC_Pocket_Type_5>
	o<toolexists> endif
o<chk_pocket>endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_6> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_6>> = #<ATC_Pocket_Type_6>
	o<toolexists> endif
o<chk_pocket>endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_7> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_7>> = #<ATC_Pocket_Type_7>
	o<toolexists> endif
o<chk_pocket>endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_8> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_8>> = #<ATC_Pocket_Type_8>
	o<toolexists> endif
o<chk_pocket>endif
...
o<chk_pocket>if[#<_ATC_Tool_Pocket_9> GT 0]
	...
	o<toolexists> else
		...
		#<_tool_par6_num|#<_ATC_Tool_Pocket_9>> = #<ATC_Pocket_Type_9>
	o<toolexists> endif
o<chk_pocket>endif