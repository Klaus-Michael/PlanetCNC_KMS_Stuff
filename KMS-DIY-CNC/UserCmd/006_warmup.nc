...
(dlg,Min Feedrate, x=100, dec=0, def=#<_warmup_min_feedrate>, min=500, max=#<_motorspeed_axis>, param=_warmup_min_feedrate)
(dlg,Max Feedrate, x=100, dec=0, def=#<_warmup_max_feedrate>, min=500, max=#<_motorspeed_axis>, param=_warmup_max_feedrate)
