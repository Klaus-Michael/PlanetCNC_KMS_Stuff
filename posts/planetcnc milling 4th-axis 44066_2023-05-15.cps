...
description = "PlanetCNC with 4th Axis 2023-05-15 mod by KMS";
...
properties = {
  ...
  showSequenceNumbers: {
    ...
    value: "false",   //KMS 2022-10-25 Set Custom Default
    scope: "post"
  },
  sequenceNumberStart: {
...
var settings = {
  ...
  workPlaneMethod: {
    ...
    optimizeType          : undefined // can be set to OPTIMIZE_NONE, OPTIMIZE_BOTH, OPTIMIZE_TABLES, OPTIMIZE_HEADS, OPTIMIZE_AXIS. 'undefined' uses legacy rotations  KMS set
  },
  comments: {
...
function activateMachine() {
  ...
  if (machineConfiguration.isHeadConfiguration() && compensateToolLength) {
    ...
    optimizeMachineAngles2(OPTIMIZE_BOTH);  // KMS change to OPTIMIZE_BOTH instead of OPTIMIZE_AXIS
  }
}
...
function defineMachine() {
  ...
  if (true) { // note: setup your machine here 
    var bAxis = createAxis({coordinate:1, table:true, axis:[0, 1, 0], cyclic:true, preference:0});  //KMS 2022-10-25 enable B Axis
...
properties.useSmoothing = {
  ...
  value: "1",   //KMS 2022-10-25 Set Custom Default
  scope: "post"
};
